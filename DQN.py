...
class DAgent():
    def __init__(self, gamma, epsilon, lr, input_dims, batch_size, n_actions,
        ...
        self.policy_net= DeepQNetwork(lr, n_actions=self.n_actions, input_dims = input_dims, fc_1_dims=FC_1_DIMS, fc_2_dims=FC_2_DIMS, fc_3_dims=FC_3_DIMS)
        self.target_net = DeepQNetwork(lr, n_actions=self.n_actions, input_dims = input_dims, fc_1_dims=FC_1_DIMS, fc_2_dims=FC_2_DIMS, fc_3_dims=FC_3_DIMS)
        if ckpt:
